...
exports.listenToIntentChangeEvent = function(req, res, next) {
  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => {
       serviceId=payload.event.incident.affects[0].id
       incident=payload.event.incident.id
    ...
    .then(() => {
      handlerUtils.createIssue(serviceId,incident)
     })
    /* XXXXXXXXXXXXX Huawei IRC - End  XXXXXXXXXXXXXXXx*/
...
exports.listenToIntentReportCreateEvent = function(req, res, next) {
  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => {
      ...
      if (parseInt(reportNumber) > parseInt(maxReport)) {
