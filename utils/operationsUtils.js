...
function processCommonAttributes(req, type, obj) {
  ...
  return new Promise(function(resolve, reject) {    
    ...
    if(typeprops.lastUpdate!==undefined) {
       obj.lastUpdate = date_start;
    }
    if(typeprops.statusChangeDate!==undefined) {
      obj.statusChangeDate = date_start;
    }
    if(typeprops.creationDate!==undefined) {
      obj.creationDate = date_start;
    }
    if(typeprops.validFor!==undefined) {
      obj.validFor.startDateTime = date_start;
      obj.validFor.endDateTime = date_end;
    }
